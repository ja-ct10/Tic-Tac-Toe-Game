...
public class SecondPlayer extends javax.swing.JFrame {
    ...
    public SecondPlayer(GameMode gm, String fp) {
        this.gm = gm;
        this.fp = fp;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        spName.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        spName.setBorder(null);
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, kGradientPanel1Layout.createSequentialGroup()
                        .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(kGradientPanel1Layout.createSequentialGroup()
                                .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(spName, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(kGradientPanel1Layout.createSequentialGroup()
                                        .addGap(42, 42, 42)
        ...
        kGradientPanel1Layout.setVerticalGroup(
            ...
            .addGroup(kGradientPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(spName, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(22, 22, 22)
    ...
    private void BtnEnterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEnterActionPerformed
        String playername = spName.getText().trim();
        if(playername.isEmpty()){
            JOptionPane.showMessageDialog(null, "Please enter your name.");
            return;
        }
        MultiPlayer play = new MultiPlayer(fp, playername);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SecondPlayer(new GameMode(), "").setVisible(true);
            }
        });
    }
